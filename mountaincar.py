...
Original file is located at
    https://colab.research.google.com/drive/1F4hWmQjRTcfkqAGewurJywOGGhCO-PUh
"""
...
def save_frames_as_gif(frames, filename='mountaincar_test.gif', path='./mountaincar_gifs/'):
